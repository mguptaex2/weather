class weatherforecast
{
    ...
    pressure : any;
    summary ; any;
    weatherforecast(time : any , temperature : any,pressure:any,summary:any)
    {
        this.time = time;
            ...
            return fetch('https://cors-anywhere.herokuapp.com/https://api.darksky.net/forecast/9799c5aedd90c08edac7f8af73c81ba9/' + lat + ',' + lng)
                .then(response => {
                    ...
                    //     // }
                        ...
                        hourdata = "<b><u>Date:-</b></u>" + formattedTime + "<br><b>Temp is</b>:- " + temp + "<br><b>Pressure is</b>:- " + this.pressure + "<br><b>Summary is :-</b>" + this.summary + " <br>";
